...
# Implement setRTS and setDTR functions in serial.py source file. If your implementation is correct,
# then this program should print following to standard output:

### START OF EXAMPLE OUTPUT ###
# Note: original 8250A RS-232 controller would reset with both RTS and DTR set to OFF.
#       This simulated 8250A resets both RTS and DTR to ON for educational purposes.
#       The simulated RS-232 mouse requires reset to start working properly - also for educational purposes.
# Initializing RS-232 port ...
# Initializing serial mouse ...
# RS-232 line state changed to: | RTS OFF | DTR +5V |
# RS-232 line state changed to: | RTS OFF | DTR OFF |
# RS-232 line state changed to: | RTS OFF | DTR +5V |
# RS-232 line state changed to: | RTS +5V | DTR +5V |
# Serial mouse initialization completed ...
# 
# V3: Using bitwise ops to parse button state: waiting for mouse packets (press and hold Ctrl key to continue to next example):
# Packet[ 40 00 00 00 ]=--- Packet[ 60 00 00 00 ]=L-- Packet[ 70 00 00 00 ]=L-R Packet[ 60 00 00 00 ]=L-- Packet[ 60 2C 1C 00 ]=L-- Packet[ 45 02 11 00 ]=--- Packet[ 4F 3F 3E 00 ]=---
