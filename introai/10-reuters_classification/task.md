...
For the dataset and the neural network, we used Keras which runs on top of TensorFlow. You can read up on all of the features provided by Keras on the [webpage](https://keras.io/) of the project.
